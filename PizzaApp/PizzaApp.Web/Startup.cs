...
using PizzaApp.Services.Helpers;
...
namespace PizzaApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Initialize connection with Database by using sql server
            // If you use SQLExpress: "Server=.\\SQLExpress;Database=PizzaAppDb;Trusted_Connection=True"
